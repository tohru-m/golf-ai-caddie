...
[data-testid="stColumn"]:has(#reset-all-anchor) button { background-color: #fed7aa !important; border-color: #fb923c !important; color: #7c2d12 !important; font-size: 22px !important; }
div:has(#load-preset-anchor) + div[data-testid="stButton"] > button { font-size: 22px !important; }
.hole-header { background: linear-gradient(135deg, #1a2e44 0%, #2d4a6e 100%); color: white; border-radius: 20px; padding: 20px 18px; margin: 10px 0 20px 0; display: flex; align-items: center; justify-content: flex-start; gap: 8px; }
.hole-header h2 { margin: 0; font-size: 24px; font-weight: 900; color: white; white-space: nowrap; }
.hole-header .sub { font-size: 24px; font-weight: 900; color: #93c5fd; white-space: nowrap; }
...
div[data-testid="stFormSubmitButton"] > button, div[data-testid="stButton"] > button { height: 62px !important; font-size: 32px !important; font-weight: 700 !important; border-radius: 12px !important; width: 100% !important; padding-top: 0 !important; padding-bottom: 0 !important; transition: all 0.15s ease; }
div:has(#preset-select-anchor) + div [data-testid="stSelectbox"] > div > div, div:has(#preset-select-anchor) + div [data-testid="stSelectbox"] select { font-size: 14px !important; min-height: 28px !important; }
...
div[data-testid="stExpander"] summary { font-size: 30px !important; font-weight: 700; }
...
div[data-testid="stRadio"] label:has(input[type="radio"]:checked) p, div[data-testid="stRadio"] label:has(input[type="radio"]:checked) span { color: white !important; }
...
[data-testid="stRadio"] > div:last-child:has(> label:nth-child(10)):not(:has(> label:nth-child(11))) label p, [data-testid="stRadio"] > div:last-child:has(> label:nth-child(10)):not(:has(> label:nth-child(11))) label span { font-size: 18px !important; }
[data-testid="stRadio"] > div:last-child:has(> label:nth-child(10)):not(:has(> label:nth-child(11))) label:nth-child(10) p, [data-testid="stRadio"] > div:last-child:has(> label:nth-child(10)):not(:has(> label:nth-child(11))) label:nth-child(10) span { color: #e53e3e !important; }
/* ===== クラブ選択グリッド（8択＝友達用） ===== */
[data-testid="stRadio"] > div:last-child:has(> label:nth-child(8)):not(:has(> label:nth-child(9))) { grid-template-columns: repeat(4, 1fr) !important; width: 100% !important; }
[data-testid="stRadio"] > div:last-child:has(> label:nth-child(8)):not(:has(> label:nth-child(9))) label > *:first-child { display: none !important; }
</style>
...
PRESET_COURSES = {
    "大阪パブリックゴルフ場（フロント）": {
        ...
        "tee": "FRO",
        "holes": {
            1:  {"par": 4, "yard": 228}, 2:  {"par": 4, "yard": 282},
            3:  {"par": 5, "yard": 506}, 4:  {"par": 4, "yard": 235},
            5:  {"par": 5, "yard": 410}, 6:  {"par": 3, "yard": 115},
            7:  {"par": 3, "yard": 154}, 8:  {"par": 4, "yard": 226},
            9:  {"par": 3, "yard": 146}, 10: {"par": 4, "yard": 257},
            11: {"par": 3, "yard": 180}, 12: {"par": 3, "yard": 127},
            13: {"par": 5, "yard": 530}, 14: {"par": 4, "yard": 295},
            15: {"par": 4, "yard": 234}, 16: {"par": 4, "yard": 298},
            17: {"par": 4, "yard": 238}, 18: {"par": 4, "yard": 250},
        }
    },
    "大阪パブリックゴルフ場（レディース）": {
        "name": "大阪パブリックゴルフ場",
        "tee": "LADIES",
        "holes": {
            1:  {"par": 4, "yard": 223}, 2:  {"par": 4, "yard": 282},
            3:  {"par": 5, "yard": 435}, 4:  {"par": 4, "yard": 230},
            5:  {"par": 5, "yard": 358}, 6:  {"par": 3, "yard": 112},
            7:  {"par": 3, "yard": 154}, 8:  {"par": 4, "yard": 200},
            9:  {"par": 3, "yard": 146}, 10: {"par": 4, "yard": 255},
            11: {"par": 3, "yard": 178}, 12: {"par": 3, "yard": 127},
            13: {"par": 5, "yard": 418}, 14: {"par": 4, "yard": 292},
            15: {"par": 4, "yard": 232}, 16: {"par": 4, "yard": 298},
            17: {"par": 4, "yard": 234}, 18: {"par": 4, "yard": 250},
        }
    },
    "宝塚ゴルフ倶楽部新C（フロント）": {
        "name": "宝塚ゴルフ倶楽部",
        "tee": "FRO",
        "holes": {
            1:  {"par": 5, "yard": 425}, 2:  {"par": 4, "yard": 276},
            3:  {"par": 3, "yard": 180}, 4:  {"par": 5, "yard": 438},
            5:  {"par": 4, "yard": 316}, 6:  {"par": 4, "yard": 425},
            7:  {"par": 3, "yard": 138}, 8:  {"par": 4, "yard": 424},
            9:  {"par": 4, "yard": 388}, 10: {"par": 5, "yard": 457},
            11: {"par": 4, "yard": 271}, 12: {"par": 3, "yard": 134},
            13: {"par": 4, "yard": 376}, 14: {"par": 4, "yard": 423},
            15: {"par": 3, "yard": 179}, 16: {"par": 4, "yard": 320},
            17: {"par": 5, "yard": 478}, 18: {"par": 4, "yard": 408},
        }
    },
}

# =====================================================
# ★ 変更①：友達用クラブ設定（画像から読み取り）
# =====================================================
CLUBS = [
    {"name": "1W", "dist": 150, "miss": 0.32, "favorite": 140},
    {"name": "5W", "dist": 140, "miss": 0.32, "favorite": 130},
    {"name": "5U", "dist": 130, "miss": 0.32, "favorite": 120},
    {"name": "7I", "dist": 120, "miss": 0.25, "favorite": 110},
    {"name": "8I", "dist": 100, "miss": 0.25, "favorite":  90},
    {"name": "9I", "dist":  80, "miss": 0.17, "favorite":  60},
    {"name": "PW", "dist":  60, "miss": 0.17, "favorite":  40},
    {"name": "SW", "dist":  40, "miss": 0.17, "favorite":  30},
]
...
def choose_club(remaining, shots_left, is_first_shot, par_num, hole):
    ...
    for club in valid_clubs:
        ...
        score = (expected_after + next_best * (3 / shots_left) + abs(club["dist"] - target)
                 + favorite_penalty * 2 + distance_balance_penalty + danger_penalty)
        if score < best_score:
            best_score = score
            best = club
    if best is None:
...
def plan(total_dist, strokes, used, par_num, hole):
    ...
    for i in range(strokes):
        ...
        shot_dist = club["dist"]
        result.append({"shot": i + 1, "club": club["name"], "dist": shot_dist,
...
def render_score_table(holes, hole_targets):
    for h in holes:
        par = st.session_state.course[h]["par"]; yard = st.session_state.course[h]["yard"]
        target = hole_targets[h]; diff = target - par
        ...
        if actual != "":
            ...
            st.markdown(f"<div class='score-cell' style='padding-left:8px; font-size:26px;'><span style='color:{actual_color}; font-weight:700;'>実績{actual}{actual_name}</span>　<span style='color:{dev_color}; font-weight:700;'>差異{deviation}</span></div>", unsafe_allow_html=True)
...
st.markdown(
    ...
    f"<div style='font-size:24px; font-weight:700; margin-top:0px;'>目標比：<span style='color:{target_color}; font-size:26px;'>{target_str}</span>　パー比：<span style='color:{par_color}; font-size:26px;'>{par_str}</span></div>"
...
st.markdown(f'<div class="hole-header"><h2>⛳ {hole}番ホール</h2><div class="sub">{TOTAL_DIST}y ／ Par {par_num}</div></div>', unsafe_allow_html=True)

if "prev_hole" not in st.session_state:
    st.session_state.prev_hole = hole
if hole != st.session_state.prev_hole:
    st.session_state.remaining = TOTAL_DIST; st.session_state.history = []
    st.session_state.prev_hole = hole; st.session_state.green_on_flag = False
...
label_text = label.split(' ', 1)[1] if ' ' in label else label
st.markdown(f"<div style='font-size:20px; font-weight:700; color:#1a1a1a; padding-bottom:4px;'>（AI推奨：{recommended_score}打 {label_text}）</div>", unsafe_allow_html=True)
...
st.markdown(f"<div style='font-size:24px; font-weight:700; color:{sel_color}; margin-top:6px; margin-bottom:2px;'>{current_target}打　{sel_label_text}</div>", unsafe_allow_html=True)
...
st.markdown(f"<div style='font-size:22px; font-weight:700; color:#e53e3e; margin-top:6px;'>ショット{shot_strokes}回＋パット{putts}回</div>", unsafe_allow_html=True)

if target < par_num - 1:
    st.error("それは無謀です！"); st.stop()
...
if use_danger:
    ...
    for i in range(1, 3):
        st.markdown(f"**エリア {i}**")
        st.selectbox("種類", danger_options, index=0, key=f"danger_type_{hole}_{i}")
        ca, cb = st.columns(2)
        with ca: st.selectbox("開始（y）", yard_options, index=0, key=f"danger_start_{hole}_{i}")
        with cb: st.selectbox("終了（y）", yard_options, index=0, key=f"danger_end_{hole}_{i}")
        if i < 2: st.markdown("<div class='section-divider'></div>", unsafe_allow_html=True)
...
st.markdown(f'<div class="remain-badge">📍 現在の残り距離　<span style="font-size:32px; font-weight:900;">{st.session_state.remaining}y</span></div>', unsafe_allow_html=True)

current_shot = 1
for h in st.session_state.history:
    result_text = {"OB": "OB（1打罰）", "池": "池（1打罰）", "赤杭": "赤杭（1打罰）", "ロスト": "ロスト（2打罰）",
                   "空振り": "空振り", "FW": "FW", "ラフ": "ラフ", "プレ4": "プレ4（2打罰）", "プレ3": "プレ3（1打罰）"}.get(h.get("result", ""), "")
    green_on_mark = " <span style='font-size:20px;'>🚩グリーンオン</span>" if h.get("green_on") else ""
    suffix = f" ⚡ {result_text}" if result_text else ""
    st.markdown(f"<div class='shot-row-history'>✅ （実績）：{h['club']} {h['dist']}y{green_on_mark}{suffix}</div>", unsafe_allow_html=True)
...
if st.session_state.remaining == 0:
    ...
    for i, p in enumerate(plan_data):
        ...
        if green_on_here or (is_last and display_dist >= p["before"]):
            ...
            if margin > 0:
                st.markdown(f"<div style='background:#dcfce7; border-left:4px solid #16a34a; border-radius:8px; padding:10px 20px; margin-top:8px; font-size:22px; font-weight:700; color:#15803d;'>🟢 {margin}打余裕があります</div>", unsafe_allow_html=True)
            st.markdown(f"<div class='shot-row'><strong>パット {putts}回</strong></div>", unsafe_allow_html=True)
            break
        elif is_last:
...
st.markdown("<div class='voice-box'><div style='font-size:18px; color:#4b5563;'>例：「7番アイアン、150ヤード、フェアウェイ」</div><div style='font-size:18px; color:#4b5563;'>例：「1W、180ヤード、OB」</div></div>", unsafe_allow_html=True)
...
if audio_file is not None:
    ...
    if text:
        ...
        st.markdown(f"<div class='voice-result'>🗣️ 認識結果：{text}</div>", unsafe_allow_html=True)
        ...
        if parsed:
            if parsed.get("club") and parsed["club"] in club_names:
                st.session_state.voice_club = parsed["club"]; st.session_state.selected_club = parsed["club"]
            if parsed.get("dist", 0) > 0:
                st.session_state.voice_dist = parsed["dist"]
                st.session_state[f"dist_slider_{st.session_state.selected_club}"] = parsed["dist"]
            if parsed.get("result"):
                st.session_state.voice_result = parsed["result"]
            st.markdown(f"<div style='background:#dbeafe; border:2px solid #93c5fd; border-radius:10px; padding:12px 20px; margin-top:8px; font-size:22px; font-weight:700;'>✅ 解析結果：{parsed.get('club','?')} ／ {parsed.get('dist','?')}y ／ {parsed.get('result','?')}</div>", unsafe_allow_html=True)
            ...
            if st.button("✅ この内容で反映する", key="btn_voice_apply", use_container_width=True):
                club_name = parsed.get("club", ""); dist_val = parsed.get("dist", 0); result = parsed.get("result", "FW")
                penalty = 0; green_on = (result == "Gオン"); remain_adjust = dist_val
                if result == "OB": penalty = 1; remain_adjust = 0
                elif result == "池": penalty = 1
                elif result == "赤杭": penalty = 1
                elif result == "ロスト": penalty = 2
                elif result == "空振り": remain_adjust = 0
                elif result == "プレ4": penalty = 2; remain_adjust = 0
                elif result == "プレ3": penalty = 1; remain_adjust = 0
                elif green_on: remain_adjust = st.session_state.remaining
                st.session_state.history.append({"club": club_name, "dist": dist_val, "result": result, "penalty": penalty, "green_on": green_on})
                st.session_state.remaining = max(st.session_state.remaining - remain_adjust, 0)
                st.session_state.voice_club = None; st.session_state.voice_dist = None
                st.session_state.voice_result = None; st.session_state.voice_text = ""
                st.rerun()
        else:
...
# =====================================================
# ★ 変更③：友達のクラブに合わせたスライダー範囲
# =====================================================
CLUB_SLIDER_RANGE = {
    "1W": (50, 200), "5W": (50, 190), "5U": (50, 180),
    "7I": (40, 160), "8I": (30, 140), "9I": (20, 120),
    "PW": (10, 100), "SW": (10,  80),
}

st.markdown('<div class="ui-label-small">使ったクラブ</div>', unsafe_allow_html=True)
actual_club = st.radio("", [c["name"] for c in st.session_state.clubs], key="selected_club", label_visibility="collapsed", horizontal=True)

smin, smax = CLUB_SLIDER_RANGE.get(actual_club, (10, 200))
...
st.markdown(f'<div style="font-size:22px; font-weight:700; color:#4a5568; margin-top:8px; margin-bottom:4px;">飛距離　<span style="font-size:42px; color:#1a2e44; font-weight:900;">{current_dist}y</span></div>', unsafe_allow_html=True)
...
shot_result = st.radio("", ["FW", "ラフ", "OB", "池", "赤杭", "ロスト", "空振り", "プレ4", "プレ3", "Gオン"], key="shot_result_select", label_visibility="collapsed", horizontal=True)
...
if submitted:
    penalty = 0; green_on = (shot_result == "Gオン")
    _, _smax = CLUB_SLIDER_RANGE.get(actual_club, (10, 200))
    ...
    if shot_result == "OB": penalty = 1; remain_adjust = 0
    elif shot_result == "池": penalty = 1
    elif shot_result == "赤杭": penalty = 1
    elif shot_result == "ロスト": penalty = 2
    elif shot_result == "空振り": remain_adjust = 0
    elif shot_result == "プレ4": penalty = 2; remain_adjust = 0
    elif shot_result == "プレ3": penalty = 1; remain_adjust = 0
    st.session_state.history.append({"club": actual_club, "dist": dist_val, "result": shot_result, "penalty": penalty, "green_on": green_on})
    st.session_state.remaining = max(st.session_state.remaining - remain_adjust, 0)
    st.rerun()
...
final_score = st.radio("", list(range(1, 17)), index=max(current_score - 1, 0),
    key=f"final_score_input_{hole}", label_visibility="collapsed", horizontal=True, on_change=update_actual_score)
...
if reset_all:
    st.session_state.history = []; st.session_state.green_on_flag = False
...
with st.expander("⚙️ クラブ設定", expanded=False):
    if st.button("クラブ設定を初期に戻す", use_container_width=True):
        ...
        for k in list(st.session_state.keys()):
            if k.startswith(("name_", "dist_", "miss_")): del st.session_state[k]
        st.rerun()
    edited_clubs = []
    for i, c in enumerate(st.session_state.clubs):
        ...
        if name != "（未選択）":
            edited_clubs.append({"name": name, "dist": 0 if dist == "未設定" else dist,
...
if st.button("✅ クラブ設定を更新", use_container_width=True):
    ...
    if len(names) != len(set(names)): st.error("同じクラブは1本しか選べません"); st.stop()
    if len(edited_clubs) > 13: st.error("クラブはパターを除いて13本までです"); st.stop()
    club_order = {"1W":1,"3W":2,"5W":3,"3U":4,"4U":5,"5U":6,"6U":7,"5I":8,"6I":9,"7I":10,"8I":11,"9I":12,
    ...
    st.session_state.pop("name_0", None); st.rerun()
...
with st.expander("⛳ コース設定", expanded=st.session_state.course_expander_open):
    ...
    if selected_preset != "コースを選択":
        ...
        if st.button("↓ コース情報を読み込む", key="btn_load_preset", use_container_width=True):
            ...
            st.session_state.course = preset["holes"].copy(); st.session_state.tee_type = preset["tee"]
            st.session_state.history = []; st.session_state.green_on_flag = False
            st.session_state.course_expander_open = True; st.session_state.pop("hole_select", None)
            st.session_state.remaining = list(preset["holes"].values())[0]["yard"]
            for h, data in preset["holes"].items():
                st.session_state[f"par_{h}"] = data["par"]; st.session_state[f"yard_{h}"] = data["yard"]
                st.session_state.pop(f"actual_{h}", None); st.session_state.pop(f"final_score_input_{h}", None)
            st.rerun()
    edited_course = {}
    par_options = ["Par", 3, 4, 5, 6]
    for h in st.session_state.course.keys():
        cur_par = st.session_state.course[h]["par"]; cur_yard = st.session_state.course[h]["yard"]
        ...
        with c5: yard = st.number_input("", 50, 700, cur_yard, key=f"yard_{h}", label_visibility="collapsed")
        edited_course[h] = {"par": par, "yard": yard}

with st.expander("🔑 APIキー設定", expanded=False):
    st.markdown("<div style='font-size:18px; color:#4a5568; margin-bottom:8px;'>音声入力にはOpenAI APIキーが必要です。<br>Streamlit CloudのSecretsに <code>OPENAI_API_KEY</code> を設定してください。</div>", unsafe_allow_html=True)
