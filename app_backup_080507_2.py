...
target_col1, target_col2, target_col3 = st.columns([5.5, 1, 1.5])
...
putt_col1, putt_col2 = st.columns([0.5, 1.5])

with putt_col1:

    st.markdown(
        "<div style='font-size:20px; font-weight:bold; margin-top:-2px;'>パット数は何回？</div>",
        unsafe_allow_html=True
    )
...
if use_danger:
    ...
    st.markdown(
        "<h5 style='margin-top:5px; margin-bottom:0px;'>⚠️ 要注意エリア</h5>",
        unsafe_allow_html=True
    )
    ...
    for i in range(1, 3):
        ...
        with c3:
            ...
            st.markdown(
                "<div style='margin-top:10px;'>から</div>",
                unsafe_allow_html=True
            )
        ...
        with c5:
            ...
            st.markdown(
                "<div style='margin-top:10px;'>ヤード</div>",
                unsafe_allow_html=True
            )
...
with st.form("shot_form"):
    ...
    with c3:
        ...
        st.markdown(
            "<div style='margin-bottom:5px;'>結果</div>",
            unsafe_allow_html=True
        )
