...
st.markdown(
    "<h5 style='margin-bottom:-15px;'>何打で回りたい？</h5>",
...
with left_block:
    ...
    for h in front9:
        ...
        with row1:
            st.markdown(
                f"<div style='font-size:18px; line-height:0.8; margin-bottom:-8px'>{h}</div>",
                unsafe_allow_html=True
            )
        ...
        with row3:
            st.markdown(
                f"<div style='font-size:18px; line-height:0.8; margin-bottom:-8px;'>"
                f"{strategy_html}"
                f"</div>",
                unsafe_allow_html=True
            )
        ...
        with row5:
            st.markdown(
                f"<div style='font-size:18px; line-height:0.8; margin-bottom:-8px;'>{deviation}</div>",
                unsafe_allow_html=True
            )
...
with right_block:
    ...
    for h in back9:
        ...
        with row3:
            st.markdown(
                f"<div style='font-size:18px; line-height:1.0;'>"
                f"{strategy_html}"
                f"</div>",
                unsafe_allow_html=True
            )
...
st.markdown(
    f"<h5 style='margin-bottom:-30px;'>"
    f"何打で上がる計画にする？ "
    f"<span style='color:{recommend_color}; font-weight:bold;'>"
    f"（AI推奨：{recommended_score}打 {score_name}）"
    f"</span>"
    f"</h5>",
    unsafe_allow_html=True
)
