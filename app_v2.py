...
/* ===== 音声再生プレーヤー ===== */
[data-testid="stAudio"] audio { width:64px !important; height:48px !important; }
...
[data-testid="stAudio"] audio::-webkit-media-controls-play-button { width:48px !important; height:48px !important; }
...
st.markdown(
    ...
    "🎤 キャディに話しかける</div>", unsafe_allow_html=True)
st.markdown(
