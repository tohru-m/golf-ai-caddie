...
PRESET_COURSES = {
    ...
    "PGM池田CC 五月平（ブルー）": {
        "name": "PGM池田カントリー", "tee": "BLU",
        "holes": {
            1: {"par": 4, "yard": 384, "memo": "HDCP8。広々としたフェアウェイ、400y超の距離がある代表的なホール。フェアウェイをキープしグリーンを狙う。"},
            2: {"par": 5, "yard": 510, "memo": "HDCP2。ティショットはやや左にドッグレッグ。セカンドからはストレートで打ち下ろす砲台グリーンのロングホール。正確なアプローチが必要。"},
            3: {"par": 4, "yard": 431, "memo": "HDCP5。左側はOBのためティショットは右サイド狙い。グリーンまで緩やかな上りでヤーデージ以上に長く感じる難ホール。"},
            4: {"par": 4, "yard": 397, "memo": "HDCP4。大阪空港方向へ豪快に打ち下ろすホール。セカンドは正確な距離感が要求される。"},
            5: {"par": 4, "yard": 397, "memo": "HDCP1。左ラフではメタセコイヤの木がブラインド、右ラフではグリーンオンが難しくなる。ティショットの落とし所が最重要。"},
            6: {"par": 3, "yard": 160, "memo": "HDCP7。見た目以上に長く感じるショートホール。グリーンは右上から左下への縦長で、ワンオンしても油断するとボギーになりやすい。"},
            7: {"par": 5, "yard": 538, "memo": "HDCP3。第3打の距離感がキーポイント。ティ・セカンド共に右OBを避けフェアウェイ左サイドへ。サードショットでいかにピンに絡めるかが勝負。"},
            8: {"par": 3, "yard": 159, "memo": "HDCP9。円形の砲台グリーンへのワンオンが鍵。グリーンをはずすとパーセーブが困難な難しいアプローチが待つ。"},
            9: {"par": 4, "yard": 390, "memo": "HDCP6。左右セーフだが両サイドとも林にセパレートされ引き締まった雰囲気。ドライバーショットは大きく曲げないよう要注意。"},
        }
    },
    "PGM池田CC 五月平（ホワイト）": {
        "name": "PGM池田カントリー", "tee": "WHT",
        "holes": {
            1: {"par": 4, "yard": 361, "memo": "HDCP8。広々としたフェアウェイ、400y超の距離がある代表的なホール。フェアウェイをキープしグリーンを狙う。"},
            2: {"par": 5, "yard": 483, "memo": "HDCP2。ティショットはやや左にドッグレッグ。セカンドからはストレートで打ち下ろす砲台グリーンのロングホール。正確なアプローチが必要。"},
            3: {"par": 4, "yard": 397, "memo": "HDCP5。左側はOBのためティショットは右サイド狙い。グリーンまで緩やかな上りでヤーデージ以上に長く感じる難ホール。"},
            4: {"par": 4, "yard": 383, "memo": "HDCP4。大阪空港方向へ豪快に打ち下ろすホール。セカンドは正確な距離感が要求される。"},
            5: {"par": 4, "yard": 386, "memo": "HDCP1。左ラフではメタセコイヤの木がブラインド、右ラフではグリーンオンが難しくなる。ティショットの落とし所が最重要。"},
            6: {"par": 3, "yard": 150, "memo": "HDCP7。見た目以上に長く感じるショートホール。グリーンは右上から左下への縦長で、ワンオンしても油断するとボギーになりやすい。"},
            7: {"par": 5, "yard": 523, "memo": "HDCP3。第3打の距離感がキーポイント。ティ・セカンド共に右OBを避けフェアウェイ左サイドへ。サードショットでいかにピンに絡めるかが勝負。"},
            8: {"par": 3, "yard": 154, "memo": "HDCP9。円形の砲台グリーンへのワンオンが鍵。グリーンをはずすとパーセーブが困難な難しいアプローチが待つ。"},
            9: {"par": 4, "yard": 370, "memo": "HDCP6。左右セーフだが両サイドとも林にセパレートされ引き締まった雰囲気。ドライバーショットは大きく曲げないよう要注意。"},
        }
    },
    "PGM池田CC 五月平（レッド）": {
        "name": "PGM池田カントリー", "tee": "RED",
        "holes": {
            1: {"par": 4, "yard": 285, "memo": "HDCP8。広々としたフェアウェイ、400y超の距離がある代表的なホール。フェアウェイをキープしグリーンを狙う。"},
            2: {"par": 5, "yard": 355, "memo": "HDCP2。ティショットはやや左にドッグレッグ。セカンドからはストレートで打ち下ろす砲台グリーンのロングホール。正確なアプローチが必要。"},
            3: {"par": 4, "yard": 290, "memo": "HDCP5。ミドルホール。フェアウェイキープが重要。"},
            4: {"par": 4, "yard": 285, "memo": "HDCP4。大阪空港方向へ豪快に打ち下ろすホール。セカンドは正確な距離感が要求される。"},
            5: {"par": 4, "yard": 285, "memo": "HDCP1。左ラフではメタセコイヤの木がブラインド、右ラフではグリーンオンが難しくなる。ティショットの落とし所が最重要。"},
            6: {"par": 3, "yard": 124, "memo": "HDCP7。見た目以上に長く感じるショートホール。グリーンは右上から左下への縦長で、ワンオンしても油断するとボギーになりやすい。"},
            7: {"par": 5, "yard": 355, "memo": "HDCP3。第3打の距離感がキーポイント。ティ・セカンド共に右OBを避けフェアウェイ左サイドへ。サードショットでいかにピンに絡めるかが勝負。"},
            8: {"par": 3, "yard":  99, "memo": "HDCP9。円形の砲台グリーンへのワンオンが鍵。グリーンをはずすとパーセーブが困難な難しいアプローチが待つ。"},
            9: {"par": 4, "yard": 253, "memo": "HDCP6。左右セーフだが両サイドとも林にセパレートされ引き締まった雰囲気。ドライバーショットは大きく曲げないよう要注意。"},
        }
    },
    "PGM池田CC 綾羽（ブルー）": {
        "name": "PGM池田カントリー", "tee": "BLU",
        "holes": {
            1: {"par": 4, "yard": 364, "memo": "HDCP2（10番）。左サイドのメタセコイヤが目印のストレートホール。距離感と難しいグリーン攻略がポイント。"},
            2: {"par": 5, "yard": 460, "memo": "HDCP8（11番）。ドライバーの距離と正確性が要求される難しいロングホール。ティショットが良ければセカンドは楽に打てる。"},
            3: {"par": 4, "yard": 346, "memo": "HDCP6（12番）。距離は短いがバンカーでガードされたグリーン廻りが特徴。スコアを崩しやすい当倶楽部のユニークなホール。"},
            4: {"par": 5, "yard": 533, "memo": "HDCP4（13番）。美しさと難しさが同居するロングホール。ツーオンも可能だがグリーン廻りは池と深いバンカーでガード。攻めるルートの選択が重要。"},
            5: {"par": 3, "yard": 158, "memo": "HDCP7（14番）。グリーン左右に深いバンカー。ワンオンかグリーン手前の花道へ止めたい。バンカーに入るとパーが難しくなる。"},
            6: {"par": 4, "yard": 445, "memo": "HDCP1（15番）。当倶楽部最長のミドルホール。セカンドはロングアイアンかウッドになるが、グリーン手前は広く開いており寄せワンのパーを狙いたい。"},
            7: {"par": 4, "yard": 351, "memo": "HDCP3（16番）。左右セーフで広く見えるがフェアウェイ方向へ打つのが重要。セカンドの距離感も難しくキャディのアドバイスが参考になるホール。"},
            8: {"par": 3, "yard": 162, "memo": "HDCP9（17番）。グリーン左バンカーに入れないようティショットを打ちたい。縦に細長いグリーンで風のある日は特に難しいショートホール。"},
            9: {"par": 4, "yard": 370, "memo": "HDCP5（18番）。セカンドから打ち上げになりグリーン面が見えず距離感がつかみにくい。グリーン手前の深いバンカーに要注意。最終ホール。"},
        }
    },
    "PGM池田CC 綾羽（ホワイト）": {
        "name": "PGM池田カントリー", "tee": "WHT",
        "holes": {
            1: {"par": 4, "yard": 344, "memo": "HDCP2（10番）。左サイドのメタセコイヤが目印のストレートホール。距離感と難しいグリーン攻略がポイント。"},
            2: {"par": 5, "yard": 444, "memo": "HDCP8（11番）。ドライバーの距離と正確性が要求される難しいロングホール。ティショットが良ければセカンドは楽に打てる。"},
            3: {"par": 4, "yard": 316, "memo": "HDCP6（12番）。距離は短いがバンカーでガードされたグリーン廻りが特徴。スコアを崩しやすい当倶楽部のユニークなホール。"},
            4: {"par": 5, "yard": 520, "memo": "HDCP4（13番）。美しさと難しさが同居するロングホール。ツーオンも可能だがグリーン廻りは池と深いバンカーでガード。攻めるルートの選択が重要。"},
            5: {"par": 3, "yard": 140, "memo": "HDCP7（14番）。グリーン左右に深いバンカー。ワンオンかグリーン手前の花道へ止めたい。バンカーに入るとパーが難しくなる。"},
            6: {"par": 4, "yard": 418, "memo": "HDCP1（15番）。当倶楽部最長のミドルホール。セカンドはロングアイアンかウッドになるが、グリーン手前は広く開いており寄せワンのパーを狙いたい。"},
            7: {"par": 4, "yard": 334, "memo": "HDCP3（16番）。左右セーフで広く見えるがフェアウェイ方向へ打つのが重要。セカンドの距離感も難しくキャディのアドバイスが参考になるホール。"},
            8: {"par": 3, "yard": 150, "memo": "HDCP9（17番）。グリーン左バンカーに入れないようティショットを打ちたい。縦に細長いグリーンで風のある日は特に難しいショートホール。"},
            9: {"par": 4, "yard": 355, "memo": "HDCP5（18番）。セカンドから打ち上げになりグリーン面が見えず距離感がつかみにくい。グリーン手前の深いバンカーに要注意。最終ホール。"},
        }
    },
    "PGM池田CC 綾羽（レッド）": {
        "name": "PGM池田カントリー", "tee": "RED",
        "holes": {
            1: {"par": 4, "yard": 293, "memo": "HDCP2（10番）。左サイドのメタセコイヤが目印のストレートホール。距離感と難しいグリーン攻略がポイント。"},
            2: {"par": 5, "yard": 347, "memo": "HDCP8（11番）。ドライバーの距離と正確性が要求される難しいロングホール。ティショットが良ければセカンドは楽に打てる。"},
            3: {"par": 4, "yard": 242, "memo": "HDCP6（12番）。距離は短いがバンカーでガードされたグリーン廻りが特徴。スコアを崩しやすい当倶楽部のユニークなホール。"},
            4: {"par": 5, "yard": 366, "memo": "HDCP4（13番）。美しさと難しさが同居するロングホール。ツーオンも可能だがグリーン廻りは池と深いバンカーでガード。攻めるルートの選択が重要。"},
            5: {"par": 3, "yard": 126, "memo": "HDCP7（14番）。グリーン左右に深いバンカー。ワンオンかグリーン手前の花道へ止めたい。バンカーに入るとパーが難しくなる。"},
            6: {"par": 4, "yard": 325, "memo": "HDCP1（15番）。当倶楽部最長のミドルホール。セカンドはロングアイアンかウッドになるが、グリーン手前は広く開いており寄せワンのパーを狙いたい。"},
            7: {"par": 4, "yard": 221, "memo": "HDCP3（16番）。左右セーフで広く見えるがフェアウェイ方向へ打つのが重要。セカンドの距離感も難しくキャディのアドバイスが参考になるホール。"},
            8: {"par": 3, "yard":  91, "memo": "HDCP9（17番）。グリーン左バンカーに入れないようティショットを打ちたい。縦に細長いグリーンで風のある日は特に難しいショートホール。"},
            9: {"par": 4, "yard": 242, "memo": "HDCP5（18番）。セカンドから打ち上げになりグリーン面が見えず距離感がつかみにくい。グリーン手前の深いバンカーに要注意。最終ホール。"},
        }
    },
    "PGM池田CC 衣懸（ブルー）": {
        "name": "PGM池田カントリー", "tee": "BLU",
        "holes": {
            1: {"par": 4, "yard": 385, "memo": "HDCP6（19番）。豪快に打ち下ろすホール。ロングヒッターはグリーン近くまで打ちたくなるが、巧みなバンカー配置がプレーヤーの攻略ルートと決断を試す。"},
            2: {"par": 3, "yard": 159, "memo": "HDCP8（20番）。6つある池の中で最大の池を越えるショートホール。グリーンへやや打ち下ろしでボールの落下地点がはっきり見える美しいホール。"},
            3: {"par": 4, "yard": 398, "memo": "HDCP2（21番）。左ラフを広くした改良により伸び伸びとドライバーが打てるホール。セカンドはアイアンの正確さが要求される。"},
            4: {"par": 4, "yard": 325, "memo": "HDCP4（22番）。ティショットは正面フェアウェイに170〜180yにレイアップ。セカンドは左直角のドッグレッグで池越えのショットになるミドルホール。"},
            5: {"par": 3, "yard": 191, "memo": "HDCP7（23番）。グリーンは大きく廻りもゆったりとレイアウト。思い切ってグリーンオンを狙いたい距離のあるショートホール。"},
            6: {"par": 5, "yard": 437, "memo": "HDCP3（24番）。攻め応えのあるロングホール。ティショットを豪快に飛ばし、セカンドは大阪空港・大阪市内を望む雄大な景色の中で打ち下ろす。"},
            7: {"par": 4, "yard": 347, "memo": "HDCP1（25番）。緩やかな上りで距離以上に長く感じる。砲台グリーンでヤーデージより難易度が高い最難関ホール。"},
            8: {"par": 4, "yard": 279, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9: {"par": 5, "yard": 507, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
        }
    },
    "PGM池田CC 衣懸（ホワイト）": {
        "name": "PGM池田カントリー", "tee": "WHT",
        "holes": {
            1: {"par": 4, "yard": 374, "memo": "HDCP6（19番）。豪快に打ち下ろすホール。ロングヒッターはグリーン近くまで打ちたくなるが、巧みなバンカー配置がプレーヤーの攻略ルートと決断を試す。"},
            2: {"par": 3, "yard": 155, "memo": "HDCP8（20番）。6つある池の中で最大の池を越えるショートホール。グリーンへやや打ち下ろしでボールの落下地点がはっきり見える美しいホール。"},
            3: {"par": 4, "yard": 378, "memo": "HDCP2（21番）。左ラフを広くした改良により伸び伸びとドライバーが打てるホール。セカンドはアイアンの正確さが要求される。"},
            4: {"par": 4, "yard": 313, "memo": "HDCP4（22番）。ティショットは正面フェアウェイに170〜180yにレイアップ。セカンドは左直角のドッグレッグで池越えのショットになるミドルホール。"},
            5: {"par": 3, "yard": 185, "memo": "HDCP7（23番）。グリーンは大きく廻りもゆったりとレイアウト。思い切ってグリーンオンを狙いたい距離のあるショートホール。"},
            6: {"par": 5, "yard": 414, "memo": "HDCP3（24番）。攻め応えのあるロングホール。ティショットを豪快に飛ばし、セカンドは大阪空港・大阪市内を望む雄大な景色の中で打ち下ろす。"},
            7: {"par": 4, "yard": 332, "memo": "HDCP1（25番）。緩やかな上りで距離以上に長く感じる。砲台グリーンでヤーデージより難易度が高い最難関ホール。"},
            8: {"par": 4, "yard": 254, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9: {"par": 5, "yard": 491, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
        }
    },
    "PGM池田CC 衣懸（レッド）": {
        "name": "PGM池田カントリー", "tee": "RED",
        "holes": {
            1: {"par": 4, "yard": 330, "memo": "HDCP6（19番）。豪快に打ち下ろすホール。ロングヒッターはグリーン近くまで打ちたくなるが、巧みなバンカー配置がプレーヤーの攻略ルートと決断を試す。"},
            2: {"par": 3, "yard":  43, "memo": "HDCP8（20番）。6つある池の中で最大の池を越えるショートホール。グリーンへやや打ち下ろしでボールの落下地点がはっきり見える美しいホール。"},
            3: {"par": 4, "yard": 229, "memo": "HDCP2（21番）。左ラフを広くした改良により伸び伸びとドライバーが打てるホール。セカンドはアイアンの正確さが要求される。"},
            4: {"par": 4, "yard": 280, "memo": "HDCP4（22番）。ティショットは正面フェアウェイに170〜180yにレイアップ。セカンドは左直角のドッグレッグで池越えのショットになるミドルホール。"},
            5: {"par": 3, "yard":  65, "memo": "HDCP7（23番）。ショートホール。グリーンセンター狙い。"},
            6: {"par": 5, "yard": 315, "memo": "HDCP3（24番）。攻め応えのあるロングホール。ティショットを豪快に飛ばし、セカンドは大阪空港・大阪市内を望む雄大な景色の中で打ち下ろす。"},
            7: {"par": 4, "yard": 240, "memo": "HDCP1（25番）。緩やかな上りで距離以上に長く感じる。砲台グリーンでヤーデージより難易度が高い最難関ホール。"},
            8: {"par": 4, "yard": 247, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9: {"par": 5, "yard": 399, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
        }
    },
    "PGM池田CC 衣懸→綾羽（ブルー）": {
        "name": "PGM池田カントリー", "tee": "BLU",
        "holes": {
            ...
            8:  {"par": 4, "yard": 279, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9:  {"par": 5, "yard": 507, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
            10: {"par": 4, "yard": 364, "memo": "HDCP2（10番）。左サイドのメタセコイヤが目印のストレートホール。距離感と難しいグリーン攻略がポイント。"},
            11: {"par": 5, "yard": 460, "memo": "HDCP8（11番）。ドライバーの距離と正確性が要求される難しいロングホール。ティショットが良ければセカンドは楽に打てる。"},
            12: {"par": 4, "yard": 346, "memo": "HDCP6（12番）。距離は短いがバンカーでガードされたグリーン廻りが特徴。スコアを崩しやすい当倶楽部のユニークなホール。"},
            13: {"par": 5, "yard": 533, "memo": "HDCP4（13番）。美しさと難しさが同居するロングホール。ツーオンも可能だがグリーン廻りは池と深いバンカーでガード。攻めるルートの選択が重要。"},
            14: {"par": 3, "yard": 158, "memo": "HDCP7（14番）。グリーン左右に深いバンカー。ワンオンかグリーン手前の花道へ止めたい。バンカーに入るとパーが難しくなる。"},
            15: {"par": 4, "yard": 445, "memo": "HDCP1（15番）。当倶楽部最長のミドルホール。セカンドはロングアイアンかウッドになるが、グリーン手前は広く開いており寄せワンのパーを狙いたい。"},
            16: {"par": 4, "yard": 351, "memo": "HDCP3（16番）。左右セーフで広く見えるがフェアウェイ方向へ打つのが重要。セカンドの距離感も難しくキャディのアドバイスが参考になるホール。"},
            17: {"par": 3, "yard": 162, "memo": "HDCP9（17番）。グリーン左バンカーに入れないようティショットを打ちたい。縦に細長いグリーンで風のある日は特に難しいショートホール。"},
            18: {"par": 4, "yard": 370, "memo": "HDCP5（18番）。セカンドから打ち上げになりグリーン面が見えず距離感がつかみにくい。グリーン手前の深いバンカーに要注意。最終ホール。"},
        }
    },
    "PGM池田CC 衣懸→綾羽（ホワイト）": {
        "name": "PGM池田カントリー", "tee": "WHT",
        "holes": {
            ...
            8:  {"par": 4, "yard": 254, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9:  {"par": 5, "yard": 491, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
            10: {"par": 4, "yard": 344, "memo": "HDCP2（10番）。左サイドのメタセコイヤが目印のストレートホール。距離感と難しいグリーン攻略がポイント。"},
            11: {"par": 5, "yard": 444, "memo": "HDCP8（11番）。ドライバーの距離と正確性が要求される難しいロングホール。ティショットが良ければセカンドは楽に打てる。"},
            12: {"par": 4, "yard": 316, "memo": "HDCP6（12番）。距離は短いがバンカーでガードされたグリーン廻りが特徴。スコアを崩しやすい当倶楽部のユニークなホール。"},
            13: {"par": 5, "yard": 520, "memo": "HDCP4（13番）。美しさと難しさが同居するロングホール。ツーオンも可能だがグリーン廻りは池と深いバンカーでガード。攻めるルートの選択が重要。"},
            14: {"par": 3, "yard": 140, "memo": "HDCP7（14番）。グリーン左右に深いバンカー。ワンオンかグリーン手前の花道へ止めたい。バンカーに入るとパーが難しくなる。"},
            15: {"par": 4, "yard": 418, "memo": "HDCP1（15番）。当倶楽部最長のミドルホール。セカンドはロングアイアンかウッドになるが、グリーン手前は広く開いており寄せワンのパーを狙いたい。"},
            16: {"par": 4, "yard": 334, "memo": "HDCP3（16番）。左右セーフで広く見えるがフェアウェイ方向へ打つのが重要。セカンドの距離感も難しくキャディのアドバイスが参考になるホール。"},
            17: {"par": 3, "yard": 150, "memo": "HDCP9（17番）。グリーン左バンカーに入れないようティショットを打ちたい。縦に細長いグリーンで風のある日は特に難しいショートホール。"},
            18: {"par": 4, "yard": 355, "memo": "HDCP5（18番）。セカンドから打ち上げになりグリーン面が見えず距離感がつかみにくい。グリーン手前の深いバンカーに要注意。最終ホール。"},
        }
    },
    "PGM池田CC 衣懸→綾羽（レッド）": {
        "name": "PGM池田カントリー", "tee": "RED",
        "holes": {
            ...
            8:  {"par": 4, "yard": 247, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9:  {"par": 5, "yard": 399, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
            10: {"par": 4, "yard": 293, "memo": "HDCP2（10番）。左サイドのメタセコイヤが目印のストレートホール。距離感と難しいグリーン攻略がポイント。"},
            11: {"par": 5, "yard": 347, "memo": "HDCP8（11番）。ドライバーの距離と正確性が要求される難しいロングホール。ティショットが良ければセカンドは楽に打てる。"},
            12: {"par": 4, "yard": 242, "memo": "HDCP6（12番）。距離は短いがバンカーでガードされたグリーン廻りが特徴。スコアを崩しやすい当倶楽部のユニークなホール。"},
            13: {"par": 5, "yard": 366, "memo": "HDCP4（13番）。美しさと難しさが同居するロングホール。ツーオンも可能だがグリーン廻りは池と深いバンカーでガード。攻めるルートの選択が重要。"},
            14: {"par": 3, "yard": 126, "memo": "HDCP7（14番）。グリーン左右に深いバンカー。ワンオンかグリーン手前の花道へ止めたい。バンカーに入るとパーが難しくなる。"},
            15: {"par": 4, "yard": 325, "memo": "HDCP1（15番）。当倶楽部最長のミドルホール。セカンドはロングアイアンかウッドになるが、グリーン手前は広く開いており寄せワンのパーを狙いたい。"},
            16: {"par": 4, "yard": 221, "memo": "HDCP3（16番）。左右セーフで広く見えるがフェアウェイ方向へ打つのが重要。セカンドの距離感も難しくキャディのアドバイスが参考になるホール。"},
            17: {"par": 3, "yard":  91, "memo": "HDCP9（17番）。グリーン左バンカーに入れないようティショットを打ちたい。縦に細長いグリーンで風のある日は特に難しいショートホール。"},
            18: {"par": 4, "yard": 242, "memo": "HDCP5（18番）。セカンドから打ち上げになりグリーン面が見えず距離感がつかみにくい。グリーン手前の深いバンカーに要注意。最終ホール。"},
        }
    },
    "PGM池田CC 衣懸→五月平（ブルー）": {
        "name": "PGM池田カントリー", "tee": "BLU",
        "holes": {
            ...
            8:  {"par": 4, "yard": 279, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9:  {"par": 5, "yard": 507, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
            10: {"par": 4, "yard": 384, "memo": "HDCP8（1番）。ミドルホール。フェアウェイキープからグリーンを狙う。"},
            11: {"par": 5, "yard": 510, "memo": "HDCP2（2番）。難易度の高いロングホール。刻んで確実に攻める。"},
            12: {"par": 4, "yard": 431, "memo": "HDCP5（3番）。長めのミドルホール。フェアウェイキープが重要。"},
            13: {"par": 4, "yard": 397, "memo": "HDCP4（4番）。ミドルホール。確実にフェアウェイをキープ。"},
            14: {"par": 4, "yard": 397, "memo": "HDCP1（5番）。最難関ホール。慎重に攻める。"},
            15: {"par": 3, "yard": 160, "memo": "HDCP7（6番）。見た目以上に長く感じるショートホール。グリーンは右上から左下への縦長で、ワンオンしても油断するとボギーになりやすい。"},
            16: {"par": 5, "yard": 538, "memo": "HDCP3（7番）。第3打の距離感がキーポイント。ティ・セカンド共に右OBを避けフェアウェイ左サイドへ。サードショットでいかにピンに絡めるかが勝負。"},
            17: {"par": 3, "yard": 159, "memo": "HDCP9（8番）。円形の砲台グリーンへのワンオンが鍵。グリーンをはずすとパーセーブが困難な難しいアプローチが待つ。"},
            18: {"par": 4, "yard": 390, "memo": "HDCP6（9番）。左右セーフだが両サイドとも林にセパレートされ引き締まった雰囲気。ドライバーショットは大きく曲げないよう要注意。最終ホール。"},
        }
    },
    "PGM池田CC 衣懸→五月平（ホワイト）": {
        "name": "PGM池田カントリー", "tee": "WHT",
        "holes": {
            ...
            8:  {"par": 4, "yard": 254, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9:  {"par": 5, "yard": 491, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
            10: {"par": 4, "yard": 361, "memo": "HDCP8（1番）。ミドルホール。フェアウェイキープからグリーンを狙う。"},
            11: {"par": 5, "yard": 483, "memo": "HDCP2（2番）。難易度の高いロングホール。刻んで確実に攻める。"},
            12: {"par": 4, "yard": 397, "memo": "HDCP5（3番）。長めのミドルホール。フェアウェイキープが重要。"},
            13: {"par": 4, "yard": 383, "memo": "HDCP4（4番）。ミドルホール。確実にフェアウェイをキープ。"},
            14: {"par": 4, "yard": 386, "memo": "HDCP1（5番）。最難関ホール。慎重に攻める。"},
            15: {"par": 3, "yard": 150, "memo": "HDCP7（6番）。見た目以上に長く感じるショートホール。グリーンは右上から左下への縦長で、ワンオンしても油断するとボギーになりやすい。"},
            16: {"par": 5, "yard": 523, "memo": "HDCP3（7番）。第3打の距離感がキーポイント。ティ・セカンド共に右OBを避けフェアウェイ左サイドへ。サードショットでいかにピンに絡めるかが勝負。"},
            17: {"par": 3, "yard": 154, "memo": "HDCP9（8番）。円形の砲台グリーンへのワンオンが鍵。グリーンをはずすとパーセーブが困難な難しいアプローチが待つ。"},
            18: {"par": 4, "yard": 370, "memo": "HDCP6（9番）。左右セーフだが両サイドとも林にセパレートされ引き締まった雰囲気。ドライバーショットは大きく曲げないよう要注意。最終ホール。"},
        }
    },
    "PGM池田CC 衣懸→五月平（レッド）": {
        "name": "PGM池田カントリー", "tee": "RED",
        "holes": {
            ...
            8:  {"par": 4, "yard": 247, "memo": "HDCP9（26番）。ブラックティーは200yの谷越えが要求されるが、セカンドの距離は短くアプローチ次第でバーディーチャンスになる。"},
            9:  {"par": 5, "yard": 399, "memo": "HDCP5（27番）。最終ホール。1・2打目を豪快にショット。3打目は高い砲台グリーンへのアプローチが要求され、グリーンは奥から手前に速いので要注意。"},
            10: {"par": 4, "yard": 285, "memo": "HDCP8（1番）。ミドルホール。フェアウェイキープからグリーンを狙う。"},
            11: {"par": 5, "yard": 355, "memo": "HDCP2（2番）。難易度の高いロングホール。刻んで確実に攻める。"},
            12: {"par": 4, "yard": 290, "memo": "HDCP5（3番）。ミドルホール。フェアウェイキープが重要。"},
            13: {"par": 4, "yard": 285, "memo": "HDCP4（4番）。ミドルホール。確実にフェアウェイをキープ。"},
            14: {"par": 4, "yard": 285, "memo": "HDCP1（5番）。最難関ホール。慎重に攻める。"},
            15: {"par": 3, "yard": 124, "memo": "HDCP7（6番）。見た目以上に長く感じるショートホール。グリーンは右上から左下への縦長で、ワンオンしても油断するとボギーになりやすい。"},
            16: {"par": 5, "yard": 355, "memo": "HDCP3（7番）。第3打の距離感がキーポイント。ティ・セカンド共に右OBを避けフェアウェイ左サイドへ。サードショットでいかにピンに絡めるかが勝負。"},
            17: {"par": 3, "yard":  99, "memo": "HDCP9（8番）。円形の砲台グリーンへのワンオンが鍵。グリーンをはずすとパーセーブが困難な難しいアプローチが待つ。"},
            18: {"par": 4, "yard": 253, "memo": "HDCP6（9番）。左右セーフだが両サイドとも林にセパレートされ引き締まった雰囲気。ドライバーショットは大きく曲げないよう要注意。最終ホール。"},
        }
    },
}
